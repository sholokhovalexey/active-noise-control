...
Let consider a feedback control system with [linear time-invariant](https://en.wikipedia.org/wiki/Linear_time-invariant_system) (LTI) stable plant $G$, defined by its frequency response.
